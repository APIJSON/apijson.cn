...
// APIJSON >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
  ...
  var App = {
    ...
    data: {
      ...
      project: 'http://apijson.cn:8082', // 'http://apijson.cn:8080', // 'http://localhost:8081',
      language: CodeUtil.LANGUAGE_GO, // 'Java,Kotlin,Go', // CodeUtil.LANGUAGE_JAVA,
      header: {},
      page: 0,
      count: 15,
      search: '',
...
//                  'testAccountId': this.getCurrentAccountId(),
      ...
      saveCache: function (url, key, value) {
        ...
        cache[key] = value
        localStorage.setItem('UnitAuto-Go:' + url, JSON.stringify(cache))
      },
      getCache: function (url, key, defaultValue) {
        var cache = localStorage.getItem('UnitAuto-Go:' + url)
        try {
